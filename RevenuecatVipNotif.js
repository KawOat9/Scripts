...
#!category=🔐APP
#!author=🅚Ⓐ🅦Ⓞ🅐Ⓣ
#!icon = https://raw.githubusercontent.com/KawOat9/Script-Rewrite/main/App-Icon/RevenueCat.png
...
function getAppName(ua) {
  const matched = Object.keys(mapping).find(k => ua.includes(k));
  if (matched) return decodeURIComponent(matched).replace(/\/$/, '');
  return 'Unknown App';
}
