Const version = 'V1.0.3'; // Updated version
...
if ($request.url.indexOf("api/getsyscfg") != -1) {
  ...
  if (obj.bottom_area?.cfg_list.length > 0) {
    obj.bottom_area.cfg_list = obj.bottom_area.cfg_list.filter(_0x79fd58 => _0x79fd58.node_key !== "home_page");
  }
  if (obj.my_settings?.cfg_list.length > 0) {
    obj.my_settings.cfg_list = obj.my_settings.cfg_list.filter(_0x302728 => _0x302728.cfg_category_key == "setting_service_area" || _0x302728.cfg_category_key == "setting_function_area");
  }
  $done({
  ...
  if (obj.data?.cards.length > 0) {
    obj.data.cards = obj.data.cards.filter(_0x1c9be3 => _0x1c9be3.source == "product" || _0x1c9be3.source == "recent");
  }
  $done({
    body: JSON.stringify(obj)
  });
