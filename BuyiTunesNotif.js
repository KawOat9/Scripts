...
// ========= Notification ========= //
try {
  const bundleId = (ddgksf2013 && ddgksf2013.receipt && ddgksf2013.receipt.bundle_id) || '';
  const matched = productidmap[bundleId];
  ...
  $notification.post('❌ BuyiTunes Error', e.message || 'Unknown error', '');
}
